...
def get_qa_metrics(results):
    ...
    scale_keys = {"bleu", "rouge1", "rouge2", "rougeL", "rougeLsum", "bertscore_precision", "bertscore_recall", "bertscore_f1"}
    ...
    metrics = {k: round(v * 100, 2) if k in scale_keys else round(v, 2) for k, v in metrics.items()}
    return metrics
...
# python eval_query_type.py --eval_file logs/generation_logs/longmemeval_s-contriever-argmax-gpt-4o-mini-2024-07-18-topk_3.jsonl
